...
// AGENCY and BUSINESS_OWNER are business roles, not above USER in the
// admin sense; they get the same baseline authority level here and are
// gated by ownership checks (added in later phases), not the hierarchy.
